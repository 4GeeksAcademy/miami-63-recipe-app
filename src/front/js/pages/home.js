    ...
    return (
        <div className="container-fluid text-center mt-5">
            ...
            <div className="d-flex justify-content-center row">
                <Link to={"/signup"} className="d-flex align-items-center justify-content-center bg-danger rounded-pill" style={{ fontSize: '1.5em', color: 'white', width: '200px', height: '60px' }}>Get Started</Link>
            </div>
        </div>
    );
};
