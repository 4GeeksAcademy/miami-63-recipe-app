...
export const RecipeBoard = () => {
  ...
  useEffect(() => {
    actions.fetchUserCategoriesRecipes()
    console.log(store)
  }, []);
    ...
    <>
      ...
      <div className="container">
        ...
        <div className="d-flex justify-content-between mb-4">
          ...
          <button type="button" className="btn button-accent rounded-pill" data-bs-toggle="modal" data-bs-target="#createRecipeModal">
            Create
          </button>
        </div>
          ...
          <ul className="list-group">
            {store.recipes.map((recipe, index) => (
              <li className="list-group-item" key={index}>
                <Link to={`/recipe-board/${recipe.id}`}>
      ...
      <div ref={modalRef} className="modal fade" id="createRecipeModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div className="modal-dialog modal-xl">
          <div className="modal-content" style={{ backgroundColor: '#f2f2f2' }}>
            ...
            {/* Modal - Name */}
            <div className="mb-3">
              <label htmlFor="exampleFormControlInput1" className="form-label" style={{ marginLeft: '150px' }}><b>Recipe Name:</b></label>
              <input type="name" className="form-control w-75 mx-auto" id="addName" value={name} onChange={(e) => setName(e.target.value)}></input>
            </div>

            {/* Modal - Description */}
            <div className="mb-3">
              <label htmlFor="exampleFormControlInput1" className="form-label" style={{ marginLeft: '150px' }}><b>Description:</b></label>
            ...
            {/* Modal - Ingredients */}
            <div className="mb-3">
              <label htmlFor="exampleFormControlTextarea1" className="form-label" style={{ marginLeft: '150px' }}><b>Ingredients:</b></label>
            ...
            {/* Modal - Directions */}
            <div className="mb-3">
              <label htmlFor="exampleFormControlTextarea1" className="form-label" style={{ marginLeft: '150px' }}><b>Directions:</b></label>
            ...
            <div className="col-md-10">
              <div className="row">
                <div className="col-md-6">
                  <div className="mb-3 d-flex justify-content-between" style={{ marginLeft: '150px' }}>
                    <label for="caloriesInput" className="form-label"><b>Calories:</b></label>
                ...
                <div className="col-md-6">
                  <div className="mb-3 d-flex justify-content-between" style={{ marginLeft: '150px' }}>
                    <label for="sodiumInput" className="form-label"><b>Sodium(mg):</b></label>
                ...
                <div className="col-md-6">
                  <div className="mb-3 d-flex justify-content-between" style={{ marginLeft: '150px' }}>
                    <label for="proteinInput" className="form-label"><b>Protein(g):</b></label>
                ...
                <div className="col-md-6">
                  <div className="mb-3 d-flex justify-content-between" style={{ marginLeft: '150px' }}>
                    <label for="cholestorolInput" className="form-label"><b>Cholestorol(mg):</b></label>
              ...
              <div className="row">
                <div className="col-md-6">
                  <div className="mb-3 d-flex justify-content-between" style={{ marginLeft: '150px' }}>
                    <label for="carbohydratesInput" className="form-label"><b>Carbohydrates(g):</b></label>
                ...
                <div className="col-md-6">
                  <div className="mb-3 d-flex justify-content-between" style={{ marginLeft: '150px' }}>
                    <label for="fiberInput" className="form-label"><b>Fiber(g):</b></label>
                ...
                <div className="col-md-6">
                  <div className="mb-3 d-flex justify-content-between" style={{ marginLeft: '150px' }}>
                    <label for="fatsInput" className="form-label"><b>Fats(g):</b></label>
                ...
                <div className="col-md-6">
                  <div className="mb-3 d-flex justify-content-between" style={{ marginLeft: '150px' }}>
                    <label for="sugarInput" className="form-label"><b>Sugar(g):</b></label>
